...
; style :
; dword key word is used always when accessing memory in [] brackets
...
.sub_bigint_loop:
    mov     r9, rdx             ; move by length of one bigint
                                ; move within the bigint
    lea     r9, [r9 + r8] 
    mov     eax, dword [r14 + r9]
    sbb     eax, dword [r14 + r8]
    mov     dword [r14 + r8], eax
                                ; move iterators
    lea     r8,  [r8 + 4]
    lea     r13, [r13 + 1]     
